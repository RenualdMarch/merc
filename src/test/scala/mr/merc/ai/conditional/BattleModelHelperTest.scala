...
class BattleModelHelperTest extends FunSuite {
  private val player1 = new Player("1")
  private val player2 = new Player("2")
  private val player3 = new Player("3")
  ...
  val game = new GameField(map, List(player3, player1, player2))
